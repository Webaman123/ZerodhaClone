    ...
    return ( 
         <div className="container">
            <div className="row p-5 mt-5 mb-5">
             ...
             <div className="col-4 p-5 mt-2 mb-2">
                <h4 className="">
                   <i class="fa fa-bar-chart" aria-hidden="true"></i>Kite</h4>
             ...
             <div className="col-4 p-5 mt-2 mb-2">
                <h4 className="">
                   <i class="fa fa-inr" aria-hidden="true"></i>Funds</h4>
             ...
             <div className="col-4 p-5 mt-2 mb-2">
                <h4 className="">
                   <i class="fa fa-user-circle-o" aria-hidden="true"></i>Console</h4>
             ...
             <div className="col-4 p-5 mt-2 mb-2">
                <h4 className="">
                    <i class="fa fa-check-circle-o" aria-hidden="true"></i>Coin</h4>
